    ...
    <SectionWrapper id="about">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            {/* Photo placeholder */}
            <div className="aspect-square rounded-2xl border border-white/10 bg-white/[0.02] flex items-center justify-center overflow-hidden">
              <span className="text-[#666666] text-sm font-[family-name:var(--font-jetbrains-mono)]">
                Photo placeholder
              </span>
            </div>
            {/* Decorative glow */}
            <div className="absolute -inset-4 -z-10 bg-[#E94560]/5 blur-[60px] rounded-full" />
          </motion.div>
          ...
          >
            <p className="font-[family-name:var(--font-ibm-plex-sans)] text-lg text-[#666666] leading-relaxed mb-6">
            ...
            <p className="font-[family-name:var(--font-ibm-plex-sans)] text-lg text-[#666666] leading-relaxed mb-8">
            ...
            {/* Signature phrase */}
            <p className="font-[family-name:var(--font-space-grotesk)] text-2xl lg:text-3xl font-bold text-white">
